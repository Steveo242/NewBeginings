...
export const i18nDerived = {
	...
	insufficientFunds: () => stateUrlDerived.social() ? 'INSUFFICIENT FUNDS TO PLACE THIS PLAY. PLEASE ADD FUNDS TO YOUR ACCOUNT OR LOWER THE PLAY LEVEL.' : stateI18nDerived.translate('INSUFFICIENT FUNDS TO PLACE THIS BET. PLEASE ADD FUNDS TO YOUR ACCOUNT OR LOWER THE BET LEVEL.'),
